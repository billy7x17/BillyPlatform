package com.functions.handler.impl;
...
public class HandlerImpl implements Handler
{
	...
	/* 机器人多态... */
	private Robot bot = new TuringRobot();
	...
	public ResponseMsg processTextTypeMsg(RequestMsg msg) throws IOException
	{
		...
		{
			response = RobotFactory.getRobot().chat(msg.getContent());
		}
